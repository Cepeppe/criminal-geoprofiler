...
export const DATASETS = {
  all: { name: 'Serie completa', filter: () => true },
  sw:  { name: 'Cluster Sud-Ovest', filter: (e) => e.cluster === 'sw' },
  ne:  { name: 'Cluster Nord-Est', filter: (e) => e.cluster === 'ne' },
};
